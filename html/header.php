...
<body>
	<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
		<a class="navbar-brand" href="../../modules/main/index.php">
			<?php echo $gameName?>
		</a>
...
?>
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="dropdown08" data-bs-toggle="dropdown"
						aria-expanded="false">Personnage (
						<?php echo $battleInvitationRow?>)
					</a>
					<ul class="dropdown-menu" aria-labelledby="dropdown08">
						<?php
...
?>
						<li><a class="dropdown-item" href="../../modules/battleInvitation/index.php">Invitation de
								combat (
								<?php echo $battleInvitationRow?>)
							</a></li>
						<?php
...
?>
						...
						<li><a class="dropdown-item" href="../../modules/skillPoints/index.php">Points de
								compétences</a></li>
					</ul>
				</li>
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="dropdown08" data-bs-toggle="dropdown"
						aria-expanded="false">Aventure</a>
					<ul class="dropdown-menu" aria-labelledby="dropdown08">
...
?>
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="dropdown08" data-bs-toggle="dropdown"
						aria-expanded="false">Communauté (
						<?php echo $privateConversationNumberRow + $tradeRequestRow + $tradeRow + $marketOfferQuantityRow?>)
					</a>
					<ul class="dropdown-menu" aria-labelledby="dropdown08">
						...
						<li><a class="dropdown-item" href="../../modules/privateConversation/index.php">Messagerie
								privée (
								<?php echo $privateConversationNumberRow?>)
							</a></li>
						<li><a class="dropdown-item" href="../../modules/tradeRequest/index.php">Place des échanges (
								<?php echo $tradeRequestRow + $tradeRow?>)
							</a></li>
						<li><a class="dropdown-item" href="../../modules/market/index.php">Le marché (
								<?php echo $marketOfferQuantityRow?>)
							</a></li>
					</ul>
				</li>
				<?php
...
?>
						...
						<li><a class="dropdown-item" href="../../modules/notification/index.php">Notifications (
								<?php echo $notificationNumberRow?>)
							</a></li>
