...
(1, '../../img/empty.png', 'Chevalier', 'Classe de personnage axée sur la force.', 10, 1, 2, 1, 1, 1, 1, 0, 0),
(2, '../../img/empty.png', 'Mage Noir', 'Classe de personnage axée sur la magie noire.', 10, 1, 1, 2, 1, 1, 1, 0, 0),
(3, '../../img/empty.png', 'Voleur', 'Classe de personnage axée sur l\'agilité.', 10, 1, 1, 1, 2, 1, 1, 0, 0),
(4, '../../img/empty.png', 'Guerrier', 'Classe de personnage axée sur la défense.', 10, 1, 1, 1, 1, 2, 1, 0, 0),
(5, '../../img/empty.png', 'Mage Blanc', 'Classe de personnage axée sur la défense magique.', 10, 1, 1, 1, 1, 1, 2, 0, 0);
